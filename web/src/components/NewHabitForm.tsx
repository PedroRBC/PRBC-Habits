...
export function NewHabitForm() {
    ...
    async function createNewHabit(event: FormEvent) {
        ...
        setTitle('')
        setWeekDays([])
        alert('Hábito criado com succeso!')
    }
            ...
            <label htmlFor="" className="font-semibold leading-tight mt-4">
                ...
                {avaiableWeekDays.map((weekDay, i) => {
                    return (
                        ...
                        >
                        <div className='h-8 w-8 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800 group-data-[state=checked]:bg-green-500 group-data-[state=checked]:border-green-500 transition-colors group-focus:ring-2 group-focus:ring-violet-800 group-focus:ring-offset-2 group-focus:ring-offset-bg '>
                            <Checkbox.Indicator>
